...
\begin{table}[htbp]
\centering
\caption{Sample images and captions from the Huanyu et al. dataset~\cite{mainref}}
\label{tab:examples} 
...
\subsection*{UWBench Dataset}
To supplement our evaluation with a broader and more challenging set for image captioning, we also incorporate UWBench \cite{UWBench}, a recently released benchmark specifically designed for underwater vision-language understanding. UWBench is composed of 15,003 high-resolution underwater images captured across diverse aquatic environments, such as oceans, coral reefs, and deep-sea habitats. Each image is captioned by human-verified annotations. The dataset captures rich variation in visibility, lighting conditions, and water turbidity, which provides a realistic testbed for model evaluation.

UWBench was constructed through a pipeline combining multi-source image acquisition, systematic attribute extraction, and GPT-assisted annotation quality. UWBench also offers a much larger image pool and more complex scenes, including images with poor visibility. Although the dataset also includes object referring and visual question answering tasks, we focus on the image captioning subset for our training and evaluation. Together, the two datasets allow us to assess ATHENA on both fine-grained and large-scale underwater captioning tasks.
...
\midrule
\includegraphics[width=0.33\textwidth]{figures/MantaRay0050095.jpeg} & 
...
\midrule
\includegraphics[width=0.33\textwidth]{figures/SubmarinePipeline1570016.png} & 
